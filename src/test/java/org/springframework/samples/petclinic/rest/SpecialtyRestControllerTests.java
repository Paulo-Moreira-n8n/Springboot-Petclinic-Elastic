 ...
 *
 * Ajustado para JUnit 5 (Jupiter) e compatibilidade com Spring Boot 3.x.
 */
@SpringBootTest
public class SpecialtyRestControllerTests {
    ...
    public void testGetAllSpecialtysSuccess() throws Exception {
        // Remove o primeiro (id 1), mantendo id 2 e 3
    ...
    public void testCreateSpecialtySuccess() throws Exception {
        ...
        String newSpecialtyAsJSON = objectMapper.writeValueAsString(newSpecialty);
